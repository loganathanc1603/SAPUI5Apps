sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/ui5/app/ZSAPUI5ALLAPP/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#SAPUI5Application-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#SAPUI5Application-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.sap.ui5.app.ZSAPUI5ALLAPP.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/ui5/app/ZSAPUI5ALLAPP/localService/mockserver"], function (mockserver) {
